...
<title>山科SHOP注册 — 山科SHOP·触摸版</title>
  ...
  <div class="w main">
  	<form id="frm_login" method="post" action="">
        ...
        <div class="item item-username">
          ...
          <b class="input-close" style="display:none;"></b> </div>
        <div class="item item-username">
          <input id="qq" class="txt-input txt-username" type="text" placeholder="请输入QQ号码" value="" name="username">
          <b class="input-close" style="display:none;"></b> </div>
        <div class="item item-captcha">
         
          <div class="err-tips"> 注册即视为同意 <a target="_blank" href="register.php">用户服务协议</a> </div>
        </div>
        <div class="ui-btn-wrap"> <a class="ui-btn-lg ui-btn-primary" id="register" >用户注册</a> </div>
