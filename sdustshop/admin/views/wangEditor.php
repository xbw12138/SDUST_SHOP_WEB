...
<header>
  <div class="header">
    ...
    <center>
    <input id="username" name="Username" type="hidden" value="<?php echo $_SESSION['username']; ?>"/><br>
     ...
     $(document).ready(function(){
      function tanchuang(){
        var index = layer.open({
          ...
          shadeClose: false,
          offset: '25%',
          content: "<div class='no_login_show'><h1>添加商品成功</h1><a href='javascript:location.reload()'>继续添加商品</a><a href='../../index.php'>浏览商品</a></div>"
      }); 
      }
    }); 
