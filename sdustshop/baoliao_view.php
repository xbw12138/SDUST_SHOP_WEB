...
<div class="mobile">
  ...
  <div class="view w">
    ...
    <div class="go_buy"><a href="javascript:void(0);" id="msg_s">联系卖家</a></div>
  </div>
  ...
  <div class="bl_comment w">
  	<h1>用户评论</h1>
  <!-- 多说评论框 start -->
    <div class="ds-thread" data-thread-key="<?php echo $_GET['body']; ?>" data-title="<?php echo $_GET['body']; ?>" data-url="<?php echo "http://182.254.146.68/sdustshop/baoliao_view.php?body=".$_GET['body']; ?>"></div>
  <!-- 多说评论框 end -->
  <!-- 多说公共JS代码 start (一个网页只需插入一次) -->
  <script type="text/javascript">
  var duoshuoQuery = {short_name:"sdustshop"};
    (function() {
